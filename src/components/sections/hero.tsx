...
>
  <motion.span
    ...
    className="text-white text-[clamp(1.75rem,7vw,4.5rem)] xl:text-8xl font-black leading-[1.1] tracking-tight uppercase"
  >
  ...
  <motion.span
    ...
    className="text-yellow-500 text-[clamp(2.25rem,8.5vw,5.25rem)] xl:text-9xl font-black leading-[1.1] tracking-tight uppercase drop-shadow-[0_0_20px_rgba(234,179,8,0.3)] mt-1 sm:mt-2 cursor-default"
  >
    Expert Action®
  </motion.span>
</motion.div>
...
<motion.p
  ...
  className="text-base sm:text-lg lg:text-2xl text-zinc-300 font-medium max-w-lg lg:max-w-none"
>
  ...
  {"Intraday & Options Trading"}
            ...
            <motion.ul
              variants={itemVariants}
              className="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg text-zinc-300 text-left w-full max-w-md lg:max-w-none"
            >
              <li className="flex items-start gap-3">
                <Book aria-hidden="true" className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-500 shrink-0 mt-0.5" />
              ...
              <li className="flex items-start gap-3">
                <Award aria-hidden="true" className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-500 shrink-0 mt-0.5" />
                <span>NISM-Certified Research Analyst</span>
              </li>
              <li className="flex items-start gap-3">
                <Users aria-hidden="true" className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-500 shrink-0 mt-0.5" />
                <span>1,500+ Students Trained Successfully</span>
              </li>
              <li className="flex items-start gap-3">
                <Calendar aria-hidden="true" className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-500 shrink-0 mt-0.5" />
            ...
            >
              <div className="flex flex-col gap-4 w-full sm:w-auto">
                <Link to="/courses" className="w-full sm:w-auto">
                  <motion.button
                    ...
                    className="w-full sm:w-auto px-8 sm:px-10 lg:px-12 py-3 sm:py-3.5 lg:py-4 bg-yellow-500 text-black text-sm sm:text-base lg:text-lg font-bold uppercase rounded-md hover:bg-yellow-400 transition-colors shadow-[0_0_15px_rgba(234,179,8,0.3)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B1120]"
                  >
                    Explore Courses
                  </motion.button>
                </Link>
              ...
              <div className="hidden sm:block perspective-1000 shrink-0 ml-0 lg:ml-4">
                <motion.div
                  ...
                  className="w-28 sm:w-32 lg:w-40 h-40 sm:h-44 lg:h-56 bg-[#0a192f] rounded-r-md border-l-4 border-yellow-500 shadow-2xl relative overflow-hidden transform-style-3d shadow-black/50"
                >
                  <div className="absolute inset-0 p-2 lg:p-3 flex flex-col justify-between border border-white/10">
                    <div className="text-[7px] sm:text-[8px] lg:text-[10px] text-zinc-400 text-center uppercase tracking-widest">ExpertAction</div>
                    <div className="text-xs sm:text-sm lg:text-base font-bold text-yellow-500 text-center uppercase leading-tight">Intraday Trading</div>
                    <div className="text-base sm:text-lg lg:text-2xl font-black text-white text-center">11 ENTRY SETUP</div>
                    <div className="text-[5px] sm:text-[6px] lg:text-[7px] text-zinc-500 text-center">Copyrighted Registry</div>
                  </div>
                </motion.div>
              </div>
            </motion.div>
          ...
          <motion.div
            ...
            <motion.img
              ...
              className="absolute bottom-0 w-full max-w-[240px] sm:max-w-lg md:max-w-xl lg:max-w-none object-contain z-10 drop-shadow-2xl"
              style={{
                  maskImage: `
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[85%] h-2/5 bg-primary/10 blur-[60px] sm:blur-[80px] lg:blur-[100px] rounded-full z-0" />
          </motion.div>
          ...
          >
            ...
            <div className="bg-[#111827]/80 backdrop-blur-md border border-white/10 rounded-xl p-6 sm:p-7 lg:p-8 shadow-2xl">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-black text-center uppercase mb-5 sm:mb-6 lg:mb-8 text-white tracking-wide">
              ...
              <ul className="space-y-3 sm:space-y-4 lg:space-y-5 mb-6 sm:mb-8 lg:mb-10">
                {[
                  ...
                  <motion.li
                    ...
                    className="flex items-center gap-3 text-xs sm:text-sm lg:text-base font-medium text-zinc-300"
                  >
                    <item.icon aria-hidden="true" className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-yellow-500 shrink-0" />
              ...
              <motion.button
                ...
                transition={{ duration: 0.2, ease: "easeOut" }}
                className="w-full py-3 sm:py-3.5 lg:py-4 bg-yellow-500 text-black text-sm sm:text-base lg:text-lg font-bold uppercase rounded-md hover:bg-yellow-400 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B1120]"
              >
                Join Telegram
              </motion.button>
            </div>
      ...
      <motion.div
        ...
        className="relative z-20 w-full bg-[#0a0f1c] border-y border-white/10 py-7 sm:py-8 lg:py-10 mt-10 sm:mt-12"
      >
        <div className="mx-auto max-w-7xl 2xl:max-w-[96rem] px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-y-6 gap-x-4 sm:gap-6 lg:gap-8 lg:divide-x lg:divide-white/10">
...
function StatItem({
  ...
  return (
    <div ref={ref} className={`flex items-center justify-center gap-3 sm:px-4 ${wrapperClassName}`}>
      <Icon aria-hidden="true" className={`w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 text-yellow-500 shrink-0 ${iconClassName}`} />
      <div className="min-w-0">
        <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white leading-none">{display}</div>
        <div className="text-[10px] sm:text-xs lg:text-sm text-zinc-400 uppercase tracking-wider font-semibold mt-1">{label}</div>
      </div>
    </div>
  );
}
...
function MarketPulseWidget() {
  return (
    <motion.div
      ...
      className="mb-6 p-4 sm:p-5 lg:p-6 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md flex items-center justify-between gap-3"
    >
      <div className="flex items-center gap-2 sm:gap-3 min-w-0">
        <div className="h-9 w-9 sm:h-11 sm:w-11 lg:h-12 lg:w-12 rounded-full bg-emerald-500/20 flex items-center justify-center shrink-0">
          <TrendingUp aria-hidden="true" className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-400" />
        </div>
        <div className="min-w-0">
          <div className="text-[9px] sm:text-[10px] lg:text-xs text-zinc-400 uppercase font-bold truncate">Nifty 50</div>
          <div className="text-xs sm:text-sm lg:text-base font-bold text-white truncate">22,514.65</div>
        </div>
      </div>
      <div className="text-emerald-400 text-[10px] sm:text-xs lg:text-sm font-bold bg-emerald-500/10 px-2 py-1 lg:px-3 lg:py-1.5 rounded shrink-0">
        +0.75%
      </div>
    </motion.div>
  );
  ...
  return (
    <div aria-hidden="true" className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      <video
        ...
        loop
        playsInline
        className="absolute inset-0 w-full h-full object-cover opacity-20" /* opacity-20 keeps it subtle so text is readable */
      >
        {/* Make sure the src matches the exact name of your video in the public folder */}
        <source src="/background_vid.mp4" type="video/mp4" />
      </video>

      {/* 2. Optional Dark Overlay (Ensures text stays readable even if the video has bright moments) */}
